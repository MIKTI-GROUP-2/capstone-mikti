...
type Event struct {
	*gorm.Model
	CategoryFK           int       `gorm:"column:category_id;type:integer(11)"`
	Title                string    `gorm:"column:event_title;type:varchar(255)"`
	...
	StartingPrice        int       `gorm:"column:starting_price;type:integer(11)"`
	...
	Image                string    `gorm:"column:image_url;type:varchar(255);null"`
